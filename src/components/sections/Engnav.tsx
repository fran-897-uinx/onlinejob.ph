    ...
    <nav className="bg-white dark:bg-gray-900 shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <div className="hidden xl:flex items-center gap-6 font-medium">
          <Link href="/Engineers/dashboard" className="hover:text-blue-600">
            Home
          </Link>
          <Link
            href="/Engineers/postedProjects"
            className="hover:text-blue-600"
          >
            My Projects
          </Link>
          <Link href="/Engineers/message" className="hover:text-blue-600">
            Messages <Badge color="red">3</Badge>
          </Link>
          <Link href="/Engineers/notification" className="hover:text-blue-600">
      ...
      >
        ...
        <div className="flex flex-col px-4 py-6 space-y-4">
          ...
          <Link href="/Engineers/dashboard" onClick={() => setIsOpen(false)}>
            Home
          </Link>
          <Link href="/Engineers/message" onClick={() => setIsOpen(false)}>
            Messages
          </Link>
          <Link href="/Engineers/notification" onClick={() => setIsOpen(false)}>
            Notifications <Badge color="red">3</Badge>
          </Link>
          <Link href="/Engineers/project" onClick={() => setIsOpen(false)}>
            Post a Project
          </Link>
          <Link
            href="/Engineers/postedProjects"
