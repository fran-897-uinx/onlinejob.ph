    ...
    <section className="py-16 bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition">
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              "I was placed on a robotics commissioning project within a week.
        ...
        <div className="text-center mt-20">
          <Link
            href="/realresult"
            className="border border-blue-800 text-blue-900 dark:text-blue-300 transition uppercase rounded-3xl hover:bg-blue-900 hover:text-white cursor-pointer p-3.5 px-12 font-bold"
          >
